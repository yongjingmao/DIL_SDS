...
def parse_args():
    ...
    parser.add_argument('--site', type=str, help='site name', metavar='')
    ...
    parser.add_argument('--ref_line_path', type=str, 
                        default=None, 
                        help='Paht for reference shoreline', metavar='')
    parser.add_argument('--optical', type=str, 
                        default='S2', 
                        help='Input optical mission', metavar='')
    parser.add_argument('--input_type', type=str, 
                        default='S1', 
                        help='Input noise data', metavar='')
    parser.add_argument('--cloudratio', type=float, 
                        default=0.5, 
    ...
    parser.add_argument('--num_pass', type=int, default=0, help='number of passes for training', metavar='')
...
def main(args):
    ...
    cfg['ref_line_path'] = args.ref_line_path
